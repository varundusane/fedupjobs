...
def Command(request):
    ...
    agencies = pd.DataFrame({"category": "1","job_title": "Agency 1","location": "l","country": "con 1","job_desc": "jd 1"})
    
        # iterate over DataFrame and create your objects
    for agency in agencies.itertuples():
        agency = WorkDetails.objects.create(category_id=agency.category, job_title=job_title, location=location, country= country, job_desc=job_desc)
